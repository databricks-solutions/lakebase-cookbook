      ...
      <div className="absolute z-10 flex w-full flex-col items-center justify-center px-6 text-center text-white">
        ...
        <div className="mt-4 flex w-full flex-col items-center justify-center gap-4 xs:flex-col sm:w-auto sm:flex-row">
          <Link to="/docs/category/examples" className="w-full sm:w-auto">
            <button className="w-full border-2 border-lava-700 bg-lava-700 px-8 py-2.5 align-middle font-semibold text-white hover:cursor-pointer hover:border-lava-800 hover:bg-lava-800 hover:underline xs:text-lg">
              Browse Examples
            </button>
          </Link>
