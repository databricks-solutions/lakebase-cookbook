...
- **`information_schema.semantic_*` is Snowflake's, not Unity Catalog's.** `semantic_views`,
  ...
  holding a real Databricks metric view exposed none. Reading them finds nothing in Unity Catalog.
