...
[GraphRAG](/docs/examples/graphrag/) example. HNSW rather than IVFFlat because
...
migration the [Genie caching](/docs/examples/lakebase-genie-caching/) stores use,
...
[`smoketest/aimem_index_smoketest.py`](https://github.com/databricks-solutions/lakebase-cookbook/tree/main/agents/ai_memory/smoketest/aimem_index_smoketest.py)
